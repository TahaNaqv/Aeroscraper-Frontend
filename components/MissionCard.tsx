        ...
        <div className='ml-6 flex-1'>
          ...
          <div className='flex gap-2 items-center'>
            ...
            {mission.status === "success" ?
              ...
              <>
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M3.52729 3.52851C3.78764 3.26816 4.20975 3.26816 4.4701 3.52851L12.4701 11.5285C12.7305 11.7889 12.7305 12.211 12.4701 12.4713C12.2098 12.7317 11.7876 12.7317 11.5273 12.4713L3.52729 4.47132C3.26694 4.21097 3.26694 3.78886 3.52729 3.52851Z" fill="#E4462D" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12.4708 3.52851C12.2104 3.26816 11.7883 3.26816 11.5279 3.52851L3.52794 11.5285C3.26759 11.7889 3.26759 12.211 3.52794 12.4713C3.78829 12.7317 4.2104 12.7317 4.47075 12.4713L12.4708 4.47132C12.7311 4.21097 12.7311 3.78886 12.4708 3.52851Z" fill="#E4462D" />
                </svg>
